...
args = {'model': 'nextgpt',
        'nextgpt_ckpt_path': '/home/ldtan/ldtan/jupiter/jupiter/next-gpt/Ckpt-NextGPT/NExT-GPT/ckpt/delta_ckpt/nextgpt/7b_tiva_v0',
        'max_length': 128,
        'stage': 3,
        'root_dir': '/home/ldtan/ldtan/jupiter/jupiter/next-gpt/Ckpt-NextGPT/NExT-GPT',
        'mode': 'validate',
        'pretrained_ckpt_path': '/home/ldtan/ldtan/jupiter/jupiter/next-gpt/Ckpt-NextGPT/NExT-GPT/ckpt/pretrained_ckpt/',
        }
args.update(load_config(args))
args['pretrained_ckpt_path']= '/home/ldtan/ldtan/jupiter/jupiter/next-gpt/Ckpt-NextGPT/NExT-GPT/ckpt/pretrained_ckpt/'
...
model.load_state_dict(delta_ckpt, strict=True)
